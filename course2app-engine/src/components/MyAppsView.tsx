...
import { createAndDownloadProjectZip, downloadDirectTestApk, generateAppConfigJson } from '../utils/androidGenerator';
          ...
          {filteredApps.map((app) => (
            ...
            >
              ...
              <div className="mt-5 pt-3 border-t border-slate-100">
                ...
                <div className="flex items-center justify-end gap-1.5 text-xs pt-1">
                  <button
                    type="button"
                    onClick={async (e) => {
                      e.stopPropagation();
                    ...
                    className="flex-1 flex items-center justify-center gap-1 rounded-lg border border-slate-200 bg-slate-50 py-1.5 px-2 text-[10px] font-semibold text-slate-700 hover:bg-emerald-50 hover:text-emerald-700 hover:border-emerald-200 transition-colors"
                    title="Quick Download .APK File"
                  >
                  ...
                  <button
                    ...
                    className="flex-1 flex items-center justify-center gap-1 rounded-lg border border-slate-200 bg-slate-50 py-1.5 px-2 text-[10px] font-semibold text-slate-700 hover:bg-blue-50 hover:text-blue-700 hover:border-blue-200 transition-colors"
                  ...
                  <button
                    ...
                    className="rounded-lg border border-slate-200 bg-slate-50 p-1.5 text-slate-600 hover:bg-indigo-50 hover:text-indigo-600"
                  ...
                  <button
                    ...
                    className="rounded-lg border border-slate-200 bg-slate-50 p-1.5 text-slate-400 hover:bg-rose-50 hover:text-rose-600"
                    title="Delete App"
                  >
